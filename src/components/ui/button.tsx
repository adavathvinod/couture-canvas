  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        luxury: "relative overflow-hidden bg-primary text-primary-foreground uppercase tracking-[0.2em] font-body before:absolute before:inset-0 before:bg-foreground before:scale-x-0 before:origin-left before:transition-transform before:duration-500 hover:before:scale-x-100 hover:text-background [&>span]:relative [&>span]:z-10",
        "ghost-gold": "border border-primary/40 text-foreground uppercase tracking-[0.2em] font-body hover:bg-primary hover:text-primary-foreground",
        "luxury-outline": "border border-foreground/20 text-foreground uppercase tracking-[0.2em] font-body hover:border-primary hover:text-primary",
      },
      size: {
